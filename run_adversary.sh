...
#python3 train_adversarial_agent.py --gpu $gpu --seed 0  --env CarGoal2.0-v1 --variant A --load nominal/weights/CarGoal2.0-v1_0  --steps $steps
...
python3 train_adversarial_agent.py --gpu $gpu --seed 0  --env CarGoal2.0-v1 --variant SA --load nominal/weights/CarGoal2.0-v1_0  --steps $steps
