...
#python3 train_robust_agent.py --gpu $gpu --seed 0  --env PointGoal2.0-v1 --variant 3 --load nominal/weights/PointGoal2.0-v1_0 --adv_load adversary/weights/PointGoal2.0-v1_A_0  --steps $steps
...
#v3 of adv. training, load both agent's weights
python3 train_robust_agent.py --gpu $gpu --seed 0  --env CarGoal2.0-v1 --variant 3 --load nominal/weights/CarGoal2.0-v1_0 --adv_load adversary/weights/CarGoal2.0-v1_A_0  --steps $steps
